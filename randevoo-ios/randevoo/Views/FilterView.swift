...
class FilterView: UIView {
    ...
    private func setupUI(){
        ...
        bottomView.snp.makeConstraints { (make) in
            make.bottom.equalTo(self.safeAreaLayoutGuide).inset(heightOfBottomView)
            make.left.right.equalTo(self)
            make.height.equalTo(heightOfBottomView)
        }
    ...
    let applyButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(FilterController.applyFilter), for: .touchUpInside)
        return button
    }()
