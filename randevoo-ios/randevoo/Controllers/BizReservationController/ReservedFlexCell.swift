...
class ReservedFlexCell: UICollectionViewCell {
    
    var reservedPage: ReservedPage? {
        didSet {
            guard let reservedPage = reservedPage else { return }
            
            nameLabel.text = reservedPage.label
            
            if reservedPage.isSelected {
