//
//  EditBizProfileView.swift
//  randevoo
//
//  Created by Alexander on 13/2/21.
...
class EditBizProfileView: UIView {
    ...
    private func setupUI() {
        ...
        typeStackView.addArrangedSubview(typeTextField)
        ...
        typeLabel.snp.makeConstraints { (make) in
            make.centerY.equalTo(typeStackView)
            make.height.equalTo(40)
            make.width.equalTo(100)
        }
        ...
        addSubview(typeLineView)
        typeLineView.snp.makeConstraints { (make) in
            make.top.equalTo(typeStackView.snp.bottom).offset(5)
            make.right.equalTo(self)
            make.height.equalTo(0.5)
            make.width.equalTo(self.frame.width - 130)
        }
        ...
        bioStackView.snp.makeConstraints { (make) in
            make.top.equalTo(typeLineView.snp.bottom).offset(10)
            make.left.right.lessThanOrEqualTo(self).inset(30)
            make.centerX.equalTo(self)
            make.height.equalTo(40)
        }
    ...
    let uploadProfileButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(EditBizProfileController.handleUploadProfile(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let usernameTextField: UITextField = {
        ...
        textField.addTarget(self, action: #selector(EditBizProfileController.handleUsername(_:)), for: .touchDown)
        return textField
    }()
    ...
    let typeTextField: UITextField = {
        ...
        textField.borderStyle = UITextField.BorderStyle.none
        textField.isEnabled = false
        textField.attributedPlaceholder = NSAttributedString(string: "Biz type", attributes: [NSAttributedString.Key.foregroundColor: UIColor.gray])
        return textField
    }()
    
    let typeLineView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor.gray.withAlphaComponent(0.5)
        return view
    }()
    ...
    let nameButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(EditBizProfileController.handleName(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let usernameButton: UIButton = {
        ...
        button.layer.backgroundColor = UIColor.clear.cgColor
        button.layer.borderColor = UIColor.clear.cgColor
        button.addTarget(self, action: #selector(EditBizProfileController.handleUsername(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let typeButton: UIButton = {
        ...
        button.layer.backgroundColor = UIColor.clear.cgColor
        button.layer.borderColor = UIColor.clear.cgColor
        button.addTarget(self, action: #selector(EditBizProfileController.handleType(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let bioButton: UIButton = {
        ...
        button.layer.backgroundColor = UIColor.clear.cgColor
        button.layer.borderColor = UIColor.clear.cgColor
        button.addTarget(self, action: #selector(EditBizProfileController.handleBio(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let siteButton: UIButton = {
        ...
        button.layer.backgroundColor = UIColor.clear.cgColor
        button.layer.borderColor = UIColor.clear.cgColor
        button.addTarget(self, action: #selector(EditBizProfileController.handleSite(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let locationButton: UIButton = {
        ...
        button.layer.backgroundColor = UIColor.clear.cgColor
        button.layer.borderColor = UIColor.clear.cgColor
        button.addTarget(self, action: #selector(EditBizProfileController.handleLocation(_:)), for: .touchUpInside)
        return button
    }()
}
