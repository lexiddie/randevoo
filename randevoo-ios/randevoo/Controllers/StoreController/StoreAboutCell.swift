...
class StoreAboutCell: UICollectionViewCell {
    ...
    let phoneButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(StoreController.handlePhone(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let emailButton: UIButton = {
        ...
        button.layer.backgroundColor = UIColor.clear.cgColor
        button.layer.borderColor = UIColor.clear.cgColor
        button.addTarget(self, action: #selector(StoreController.handleEmail(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let mapButton: UIButton = {
        ...
        button.layer.backgroundColor = UIColor.clear.cgColor
        button.layer.borderColor = UIColor.clear.cgColor
        button.addTarget(self, action: #selector(StoreController.handleMap(_:)), for: .touchUpInside)
        return button
    }()
