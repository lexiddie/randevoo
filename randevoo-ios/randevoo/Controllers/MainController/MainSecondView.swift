...
class MainSecondView: UIView {
    ...
    let mainImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "MainSecond")!.withRenderingMode(.alwaysOriginal)
    ...
    let detailLabel: UILabel = {
        let label = UILabel()
        label.text = "Make a reservation to checkout in store"
