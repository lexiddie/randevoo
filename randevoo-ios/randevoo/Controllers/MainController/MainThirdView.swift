...
class MainThirdView: UIView {
    ...
    let mainImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "MainThird")!.withRenderingMode(.alwaysOriginal)
    ...
    let detailLabel: UILabel = {
        let label = UILabel()
        label.text = "With seamless shopping experience"
