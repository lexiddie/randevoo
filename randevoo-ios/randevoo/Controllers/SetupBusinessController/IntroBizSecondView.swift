...
class IntroBizSecondView: UIView {
    ...
    let mainImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "IntroBizSecond")!.withRenderingMode(.alwaysOriginal)
    ...
    let introLabel: UILabel = {
        let label = UILabel()
        label.text = "Get an Instant Contact"
    ...
    let detailTextView: UITextView = {
        ...
        textView.text = "Customers can get in touch with you instantly with the provided app"
