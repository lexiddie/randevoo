//
//  AddToLikeCollectionFooter.swift
//  randevoo
//
...
protocol AddToListTextDelegate {
...
class AddToListCollectionFooter: UICollectionViewCell {
    
    var delegate: AddToListTextDelegate?
    ...
    lazy var increaseButton: UIButton = {
        ...
        button.titleLabel?.font =  UIFont(name: "Quicksand-Medium", size: 20)
...
extension AddToListCollectionFooter: UITextFieldDelegate {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        print("run this")
        let mainController = controller as! AddToListController
