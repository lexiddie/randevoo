...
protocol AddImageCollectionCellDelegate {
    func addNewImage()
}

class AddImageFooterCell: UICollectionViewCell {
    
    var delegate: AddImageCollectionCellDelegate?
