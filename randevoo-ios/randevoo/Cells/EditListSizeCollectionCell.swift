//
//  EditListSizeCollectionCell.swift
//  randevoo
//
...
class EditListSizeCollectionCell: UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
...
extension EditListSizeCollectionCell {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        } else if sizeArray[indexPath.row].size == "None"{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if sizeArray[indexPath.row].isAvailable {
            let controller = mainController as! EditListController
